# evolution-2026-04-12-oh01-inline-cleanup.md

## Plan

- path: `.claude/plans/loloop/active-site-detail-polish-v1.md`
- milestone: keep the overnight loop moving while Zhihu publication remains time-blocked
- bounded target: keep the deferred overnight media wave closed and use one more low-risk site-polish pass to remove the remaining inline source-link spacing on `oh01.html`
...
- stayed on the low-risk site-polish line because `site/oh01.html` still had one inline spacing style on the source-link paragraph
- replaced that inline style with a scoped `.oh01-source-link-spaced` class in `site/css/style.css`
- updated the source-link paragraph in `site/oh01.html` to use the new class
- verified that `site/oh01.html` no longer contains any `style=` attributes
...
- did not change the OH01 teaching content because this iteration only removed inline layout debt
