...
- 2026-04-12: fifth bounded Task 11 pass should make the new `codex-loop in sleep` page visible from the `VibePaper / AI Scientist-v2` branch so the sleep-layer line is discoverable from the main map instead of only from the topic page and AI-Scientist prose
- 2026-04-12: fifth bounded Task 11 pass landed in `site/js/app.js`, `site/topic-site-map.html`, and `site/md/topic-site-map.md`; the map now teaches `VibePaper -> AI Scientist-v2 -> codex-loop in sleep` as an explicit subchain instead of leaving the sleep line hidden behind a standalone topic page
