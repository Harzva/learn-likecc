# evolution-2026-04-12-tutorial-inline-cleanup.md

## Plan

- path: `.claude/plans/loloop/active-site-detail-polish-v1.md`
- milestone: keep the overnight loop moving while Zhihu publication remains time-blocked
- bounded target: keep the deferred overnight media wave closed and use one more low-risk site-polish pass to remove the remaining inline layout styling on `tutorial.html`
...
- stayed on the low-risk site-polish line because `site/tutorial.html` still had four inline layout styles in the `.claude/` configuration section
- replaced those inline styles with scoped tutorial-page classes in `site/css/style.css`
- updated the centered section intro, inline reference note, detail table wrapper, and spaced reference lead in `site/tutorial.html` to use the new classes
- verified that `site/tutorial.html` no longer contains any `style=` attributes
...
- did not change the tutorial teaching content because this iteration only removed inline layout debt
