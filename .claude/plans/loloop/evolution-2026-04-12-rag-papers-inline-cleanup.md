# evolution-2026-04-12-rag-papers-inline-cleanup.md

## Plan

- path: `.claude/plans/loloop/active-site-detail-polish-v1.md`
- milestone: keep the overnight loop moving while Zhihu publication remains time-blocked
- bounded target: keep the deferred overnight media wave closed and use one more low-risk site-polish pass to remove the remaining inline layout styling on `topic-rag-papers`
...
- stayed on the low-risk site-polish line because `site/topic-rag-papers.html` still had seven inline layout styles in the All-in-RAG and paper-list sections
- replaced those inline styles with scoped `rag-papers-*` classes in `site/css/style.css`
- updated the All-in-RAG section shell, intro paragraph, quickstart grid, linked quickstart cards, and paper-list block in `site/topic-rag-papers.html` to use the new classes
- verified that `site/topic-rag-papers.html` no longer contains any `style=` attributes
...
- did not expand the RAG papers page content because this iteration only removed inline layout debt
