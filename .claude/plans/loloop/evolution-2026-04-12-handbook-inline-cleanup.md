# evolution-2026-04-12-handbook-inline-cleanup.md

## Plan

- path: `.claude/plans/loloop/active-site-detail-polish-v1.md`
- milestone: keep the overnight loop moving while Zhihu publication remains time-blocked
- bounded target: keep the deferred overnight media wave closed and use one more low-risk site-polish pass to remove the remaining inline hint spacing on `handbook.html`
...
- stayed on the low-risk site-polish line because `site/handbook.html` still had one inline spacing style on the Slash Commands hint block
- replaced that inline style with a scoped `.handbook-hint-spaced` class in `site/css/style.css`
- updated the Slash Commands hint paragraph in `site/handbook.html` to use the new class
- verified that `site/handbook.html` no longer contains any `style=` attributes
...
- did not change the handbook teaching content because this iteration only removed inline layout debt
