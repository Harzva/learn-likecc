# evolution-2026-04-12-s12-inline-cleanup.md

## Plan

- path: `.claude/plans/loloop/active-site-detail-polish-v1.md`
- milestone: keep the overnight loop moving while Zhihu publication remains time-blocked
- bounded target: keep the deferred overnight media wave closed and use one more low-risk site-polish pass to remove the remaining inline reference-lead spacing on `s12.html`
...
- stayed on the low-risk site-polish line because `site/s12.html` still had one inline spacing style on the closing reference-lead paragraph
- replaced that inline style with a scoped `.s12-reference-lead-tight` class in `site/css/style.css`
- updated the closing reference-lead paragraph in `site/s12.html` to use the new class
- verified that `site/s12.html` no longer contains any `style=` attributes
...
- did not change the S12 teaching content because this iteration only removed inline layout debt
