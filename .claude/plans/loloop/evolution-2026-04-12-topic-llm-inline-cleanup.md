# evolution-2026-04-12-topic-llm-inline-cleanup.md

## Plan

- path: `.claude/plans/loloop/active-site-detail-polish-v1.md`
- milestone: keep the overnight loop moving while Zhihu publication remains time-blocked
- bounded target: keep the deferred overnight media wave closed and use one more low-risk site-polish pass to remove the remaining inline gallery/layout styling on `topic-llm`
...
- stayed on the low-risk site-polish line because `site/topic-llm.html` still had five inline layout styles across the gallery and related sections
- replaced those inline styles with scoped `llm-*` classes in `site/css/style.css`
- updated the gallery section shell, section descriptions, hero-actions block, quickstart grid, tools grid, and related section shell in `site/topic-llm.html` to use the new classes
- verified that `site/topic-llm.html` no longer contains any `style=` attributes
...
- did not expand the LLM topic body because this iteration only removed inline layout debt
