    ...
    function renderShellRecentCommands() {
        ...
        shellRecentHost.innerHTML =
            ...
            recent.map(function (command) {
                ...
                var buttonAttrs = [' aria-controls="workspace-shell-output-meta workspace-shell-output workspace-shell-status"']
                if (buttonHint) {
