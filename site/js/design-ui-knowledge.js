 ...
 */
;(function () {
    var mount = document.getElementById('design-ui-knowledge-mount')
    if (!mount) return

    var jsonUrl = mount.getAttribute('data-json') || 'data/design-ui-knowledge.json'
    ...
    function render(payload) {
        ...
        mount.innerHTML =
            ...
            '<div>' +
            '<h3 class="ds-arch-knowledge__title">Design/UI 知识图谱</h3>' +
            '<p class="ds-arch-knowledge__subtitle">三条表达壳层的层级关系与工具链映射。</p>' +
            '</div>' +
            '<div class="ds-arch-knowledge__controls"></div>' +
            '</div>' +
            '<div class="ds-arch-knowledge__layout">' +
            '<div class="ds-arch-knowledge__canvas"><svg class="ds-arch-knowledge__svg" aria-label="Design/UI 知识图谱"></svg></div>' +
