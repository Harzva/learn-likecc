...
function initSiteSidebar() {
    ...
    aside.innerHTML =
        ...
        '</details>' +
        '<details class="site-sidebar__details" data-sidebar-key="personal-knowledge">' +
        '<summary class="site-sidebar__summary"><span class="site-sidebar__txt">个人知识库</span></summary>' +
        '<a class="site-sidebar__link site-sidebar__link--sub" href="topic-personal-knowledge.html"><span class="site-sidebar__ico">📌</span><span class="site-sidebar__txt">专题首页</span></a>' +
        ...
        '<a class="site-sidebar__link site-sidebar__link--sub" href="tutorial.html#skills"><span class="site-sidebar__ico">🔧</span><span class="site-sidebar__txt">Skills</span></a>' +
        '<a class="site-sidebar__link site-sidebar__link--sub" href="topic-websites.html"><span class="site-sidebar__ico">🌐</span><span class="site-sidebar__txt">站点推荐</span></a>' +
        '</details>' +
