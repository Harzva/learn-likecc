    ...
    [
        ...
        (
            ...
            [
                ...
                "topic-cc-buddy",
                "topic-cc-commands-guide",
                "topic-cc-release-watch",
                "topic-cc-tooling-guide",
                "topic-claude-official-resources",
                "topic-claude-codex-compare",
                "topic-claude-codex-bridge",
                "topic-codex-loop-console",
                "topic-connector-runtime-daemon",
                "topic-hook-runtime",
                "topic-loop-mechanisms",
                ...
                "topic-everything-claude-code-unpacked",
                "topic-websites",
            ],
        ),
        (
        ...
        (
            ...
            [
                ...
                "topic-codex-loop-in-sleep",
                "topic-hermes-unpacked",
                "topic-paper-agent-skills-architecture",
                "topic-paper-agent-skills-data-driven",
                "topic-paper-malicious-agent-skills",
                "topic-paper-sage-skill-library",
            ],
        ),
        (
            "庖丁解牛 / 系统解构子专题",
            [
                "topic-superset-unpacked",
                "topic-cabinet-unpacked",
                "topic-multica-unpacked",
                "topic-warp-unpacked",
            ],
        ),
        (
            "工具链 / Vibe Coding 子专题",
            [
                "topic-design-ui-tutorial",
                "topic-design-ui-unpacked",
                "topic-abtop-guide",
                "topic-github-actions-guide",
                "topic-github-achievements",
                "topic-runoob-codex-tutorial",
            ],
        ),
    ]
)
